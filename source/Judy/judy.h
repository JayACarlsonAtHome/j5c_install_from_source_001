...
#ifndef J5C_INSTALL_FROM_SOURCE_001_JUDY_H
#define J5C_INSTALL_FROM_SOURCE_001_JUDY_H

int install_judy(std::map<sstr, sstr>& settings, an_itemValues& itemValues)
{
    int result = -1;
...
#endif //J5C_INSTALL_FROM_SOURCE_001_JUDY_H
