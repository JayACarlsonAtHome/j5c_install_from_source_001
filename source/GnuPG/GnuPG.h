...
#ifndef J5C_INSTALL_FROM_SOURCE_001_GNUPG_H
#define J5C_INSTALL_FROM_SOURCE_001_GNUPG_H
...
int install_gnupg(std::map<sstr, sstr>& settings, an_itemValues& itemValues)
{
    int result = -1;
...
#endif //J5C_INSTALL_FROM_SOURCE_001_GNUPG_H
