...
int install_dnf_required_dependencies(sstr& fileName, sstr& programName, bool createScriptOnly)
{
    ...
    vec.emplace_back("dnf -y install gcc-c++-x86_64-linux-gnu");
    vec.emplace_back("dnf -y install gnutls-c++");
    vec.emplace_back("dnf -y install gnutls-devel");
    vec.emplace_back("dnf -y install gtk2-devel.x86_64");
    vec.emplace_back("dnf -y install gtk3-devel.x86_64");
    ...
    vec.emplace_back("dnf -y install sqlite-tcl");
    vec.emplace_back("dnf -y install tcltls-devel");
    vec.emplace_back("dnf -y install xml2");
    vec.emplace_back("dnf -y xorg-x11-fonts*");
